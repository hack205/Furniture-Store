...
return [
    ...
    */
    ...
    | utilizando la convención "attribute.rule" para nombrar las líneas. Esto permite
    | especificar de manera rápida una línea de lenguaje personalizada para una
    | regla de atributo específica.
    |
    */
    ...
    | de posición de atributo por algo más fácil de leer, como "Dirección de Correo
    | Electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer nuestro
    | mensaje más expresivo.
    |
    */
